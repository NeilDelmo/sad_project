...
<head>
    ...
    <style>
        ...
        .subhead-font { font-family:"Koulen",sans-serif;font-weight:400;font-size:20px;color:#0074b3; }
        ...
        .forgot { color:#607d94;text-decoration:none; }
...
<body class="d-flex min-vh-100 align-items-center justify-content-center py-4">
    <div class="card shadow-sm p-4" style="max-width:460px;width:95%;">
        <div class="text-center mb-3">
            ...
            <h1 class="title-font mb-0">Forgot Password</h1>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <button type="submit" class="btn-container my-3 w-100">
                <span class="text subhead-font" style="color:#95beff;">Send Reset Link</span>
                <span class="login-icon"><i class="fa-solid fa-paper-plane"></i></span>
            </button>
            <div class="text-font text-center" style="font-size:13px;">
                Remembered? <a href="{{ route('login') }}" class="forgot">Back to Login</a>
            </div>
        </form>
    </div>
</body>
