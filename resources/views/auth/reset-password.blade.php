            ...
            <div style="max-width:520px; width:95%;">
                <div class="card shadow-sm p-4">
                    <div class="form-hero-heading mb-3">
                        ...
                        <h3 class="mb-0 title-font">New Password</h3>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                ...
                                <button class="btn btn-sm btn-link position-absolute end-0 top-50 translate-middle-y me-3" type="button" id="toggleConfirmPassword" aria-label="Show confirm password">
                        ...
                        <button type="submit" class="btn-container my-3 w-100">
                            <span class="text text-center subhead-font" style="color:#95beff;">Reset Password</span>
...
(function(){
    ...
    var iconConfirm = document.getElementById('toggleConfirmPasswordIcon');
    if (toggleConfirm && pwdConfirm && iconConfirm) {
        toggleConfirm.addEventListener('click', function () {
            if (pwdConfirm.type === 'password') {
                pwdConfirm.type = 'text';
                iconConfirm.classList.replace('fa-eye', 'fa-eye-slash');
                toggleConfirm.setAttribute('aria-label', 'Hide confirm password');
            } else {
                pwdConfirm.type = 'password';
                iconConfirm.classList.replace('fa-eye-slash', 'fa-eye');
