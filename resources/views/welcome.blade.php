    ...
    <head>
        ...
        <style>
            ...
            .email-input {
                ...
                box-shadow: none;
                transition: border-color 220ms cubic-bezier(0.2, 0.9, 0.2, 1);
            }

            .email-input:focus,
            .email-input:focus-visible,
            input.form-control.email-input:focus {
                outline: none !important;
                border-color: #0074b3 !important;
                box-shadow: none !important;
            }

            .email-input.text-font {
                color: #444253;
            }
            ...
            .btn-style {
                --btn-bg: #0074b3;
                --btn-color: #ffffff;
                --btn-hover-bg: rgba(0, 116, 179, 0.85);
            ...
            @media (max-width: 575.98px) {
                .hero-brand-top .hero-logo-top { width: 68px; }
                .hero-brand-top .hero-brand-text { font-size: 16px; }
            }
        </style>
    </head>
<body>
...
<nav class="navbar nav-style p-0">
  <div class="container-fluid bg-black text-font px-4 d-flex align-items-center">
      ...
      @if (Route::has('login'))
          @auth
              ...
              <a href="{{ url('/dashboard') }}" class="text-decoration-none">
                  <i class="fa-solid fa-house-user login-icon" style="color:#0074b3; font-size:22px;"></i>
              </a>
          @endauth
      @endif
...
<!-- end of nav -->
    ...
    <div class="card content-card d-flex flex-column text-start p-3 mx-auto mt-5" data-aos="fade-right">
        <div class="row g-3">
            ...
            <div class="p-3 h-100 d-flex flex-column justify-content-center align-items-center text-center">
                <span class="subhead-font">Zone Navigator</span>
                <p class="desc-font">
    ...
    <div class="card content-card text-start p-3 mx-auto mt-5" data-aos="fade-left">
        <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
            <div class="p-3 h-100 d-flex flex-column justify-content-center align-items-center text-center">
                <span class="subhead-font">Gear Tracking Manager</span>
                <p class="desc-font">
    ...
    <div class="card content-card text-start p-3 mx-auto mt-5" data-aos="fade-right">
        <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
            <div class="p-3 h-100 d-flex flex-column justify-content-center align-items-center text-center">
                <span class="subhead-font">SeaConnect</span>
                <p class="desc-font">
    ...
    <div class="row g-3">
        ...
        <div class="market-card">
            ...
            <div class="border rounded-bottom bottom-box text-start">
            <span class="market-font">Gear<br /></span>
        ...
        <div class="market-card">
            ...
            <div class="border rounded-bottom bottom-box text-start">
            <span class="market-font">Fish<br /></span>
            <span class="desc-font">
        ...
        <div class="market-card">
            ...
            <div class="border rounded-bottom bottom-box text-start">
            <span class="market-font">Rent<br /></span>
            <span class="desc-font">
    ...
    <footer class="site-footer mt-5 py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <small class="d-block">&copy; 2025 HAPPY Inc.</small>
                </div>
            </div>
